...
resource "aws_instance" "main" {
  ...
  subnet_id     = data.tfe_outputs.networking.nonsensitive_values.public_subnet[count.index] #var.public_subnet[count.index]
...
resource "aws_lb" "main" {
  ...
  subnets            = data.tfe_outputs.networking.nonsensitive_values.public_subnet #var.public_subnet
